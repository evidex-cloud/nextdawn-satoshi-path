...
export default function mount(root, lang) {
  ...
  const ROWS = [
    ...
    [en ? "Current block subsidy (after the 4th halving)" : "当前出块补贴（第 4 次减半后）", en ? "3.125 BTC / block" : "3.125 BTC / 区块"],
    ...
    [en ? "Next halving (the 5th)" : "下次减半（第 5 次）", en ? "~April 2028, subsidy drops to 1.5625 BTC" : "约 2028 年 4 月，补贴降到 1.5625 BTC"],
